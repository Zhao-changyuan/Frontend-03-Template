...
export class Carousel extends Component {
    ...
    render() {
        ...
        this.children.forEach((item, index) => item.root.style.backgroundImage = `url('${this[ATTRIBUTE].data[index].img}')`);
        ...
        this[STATE].position = 0;// 当前激活的位置

        let t = 0;
        let ax = 0; // animation x动画造成的位移
